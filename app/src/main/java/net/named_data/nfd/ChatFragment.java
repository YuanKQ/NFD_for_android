...
public class ChatFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        m_rThreadName = new String("" + System.currentTimeMillis());
        m_recvThread.start();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        this.m_editFace = (EditText) v.findViewById(R.id.ed_face);
        this.m_tvConsole = (TextView) v.findViewById(R.id.tv_console);
        Log.i(TAG, "onCreateView!");
        m_tvConsole.append("@@@onCreateView!\n");
        this.m_btnPing = (Button) v.findViewById(R.id.btn_ping);
        this.m_btnPing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                // TODO Auto-generated method stub
                Log.i(TAG, "Face Address: " + m_editFace.getText().toString());
                m_proDlg = ProgressDialog.show(getActivity(), "", "waiting...");

                m_netThread = new NetThread(m_editFace.getText().toString());
...
//                registeredPrefixId = recvFace.registerPrefix(prefix, echo, echo);
//            } catch (Exception e) {
//                Log.e(TAG, "Failed to register the prefix: " + e.getMessage());
//            }
//        }
...
//        }
        ...
        public void handleMessage(Message msg) {
            String viewMsg = "Empty";
            Log.i(TAG, "thread id:" + m_rThreadName);
            Log.i(TAG, "msg.what = " + msg.what);
            switch (msg.what) { // Result Code
                case 200: // Result Code Ex) Success: 200
                    viewMsg = (String) msg.obj; // Result Data..
...
//            m_tvConsole.setText(viewMsg);
    ...
    private String m_rThreadName;
    //    private String m_faceAddr;
    private MyHandler m_handler;
    private EditText m_editFace;
    private Button m_btnPing;
    private TextView m_tvConsole;
